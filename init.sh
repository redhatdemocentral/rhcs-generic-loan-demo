#!/bin/sh 
DEMO="Cloud JBoss BPM Generic Loan Demo"
AUTHORS="Dan-Grigore Pupaza, Andrew Block,"
AUTHORS2="Alexandre Porcelli, Eric D. Schabell, Duncan Doyle"
PROJECT="git@github.com:redhatdemocentral/rhcs-generic-loan-demo.git"
SRC_DIR=./installs
...
echo
oc new-project rhcs-generic-loan-demo 
			
echo
echo "Setting up a new build..."
echo
oc new-build "jbossdemocentral/developer" --name=rhcs-generic-loan-demo --binary=true
...
echo
oc new-app rhcs-generic-loan-demo
...
echo
oc expose service rhcs-generic-loan-demo --hostname=rhcs-genericloan-demo.10.1.2.2.xip.io
